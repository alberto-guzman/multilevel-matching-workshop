...
|---|---|---|
| [MIAD](05_miad.qmd) | 5 | The multisite individual assignment design, in which students are assigned to treatment within schools. The page covers seven propensity score models, four matching approaches, balance at the site level, individual-average and site-average effects, the FIRC model, and a sensitivity analysis. This is the page we run together in the room. It ends with a "Try it" block and a template for your own data. |
...
| [CAD](06_cad.qmd) | 6 | The cluster assignment design, in which whole schools are assigned to treatment. The page covers the cluster-level propensity score, cluster-global, sequential, and network-flow matching, balance at two levels, cluster-average and individual-average effects, permutation inference, and a sensitivity analysis. |
